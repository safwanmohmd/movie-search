...
const getMovie = async (movie) => {
  ...
  try {
    div.innerHTML = ""
    errrorDiv.innerHTML = ''
    let response = await fetch(`https://www.omdbapi.com/?i=tt3896198&apikey=16a7b1ef&t=${movie}&plot=short`)
  ...
  <div class="row g-0">
    <div class="col-md-4 d-flex d-md-block justify-content-center align-items-center">
      <img src="${data.Poster}" class="img-fluid rounded-start" alt="...">
    </div>
    <div class="col-md-8">
      <div class="card-body w-100 text-center d-flex flex-column justify-content-center h-100">
